  ...
  return (
    <section className="bg-transparent text-white pt-[108px] pb-24 w-full flex flex-col min-h-full px-4 md:px-8">
      <div className="container mx-auto max-w-[1400px]">
        <h1 className="text-8xl md:text-[12rem] font-bold tracking-tighter opacity-80 mb-12">2 SERVICES</h1>
        <div className="max-w-2xl text-2xl md:text-4xl font-light leading-relaxed opacity-60 space-y-12">
          <p>This is a dummy layer for the Services section.</p>
          ...
          <p>If you reach the bottom of this container and keep scrolling (pulling by 80px), the engine will seamlessly snap you to the next layer: Work.</p>
          <p>Dummy line to ensure height.</p>
          <p>Dummy line to ensure height.</p>
          <p>Dummy line to ensure height.</p>
          <p>Bottom of the dummy Services page.</p>
        </div>
      </div>
    </section>
  );
