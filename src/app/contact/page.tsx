...
export default function Contact() {
  return (
    <>
      <Navbar />
      <main className="flex flex-col min-h-screen pt-32 pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-zinc-950/50 border border-white/5 p-8 md:p-12">
              <form className="space-y-8" action={`mailto:${profile.email}`} method="post" encType="text/plain">
                ...
                <Button type="submit" size="lg" className="w-full rounded-none h-14 text-sm font-mono uppercase tracking-widest">
                  Send Message
                </Button>
              </form>
            </div>
